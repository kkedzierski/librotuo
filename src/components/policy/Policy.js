...
const Policy = () => {
    ...
    <p>Poniższa Polityka Prywatności jest integralną częścią <a href="https://librotuo.pl/policy">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
    <h2 style={{ textAlign: 'center'}}>§1 Definicje</h2>
    <ul>
        <li>
            <p><strong>Serwis</strong> - serwis internetowy "librotuo.pl" działający pod adresem https://librotuo.pl</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Kamil Kędzierski" zamieszkała w Pile, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
        </li>
        <li>
    ...
    <ul>
        ...
        <li>
            <p><strong>Cookies sesyjne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis lub Serwisy zewnętrznepodczas jednej sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z Urządzenia Użytkownika.</p>
        </li>
        <li>
    ...
    <h2 style={{ textAlign: 'center'}}>§4 Bezpieczeństwo składowania danych</h2>
    <ul>
        <li>
    ...
    <h2 style={{ textAlign: 'center'}}>§5 Cele do których wykorzystywane są pliki Cookie</h2>
    <ul id="cele">
    ...
    <h2 style={{ textAlign: 'center'}}>§6 Cele przetwarzania danych osobowych</h2>
    ...
    <h2 style={{ textAlign: 'center'}}>§7 Pliki Cookies Serwisów zewnętrznych</h2>
    ...
    <h2 style={{ textAlign: 'center'}}>§9 Dostęp do danych osobowych przez podmioty trzecie</h2>
    ...
    <p>Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych - <strong><a rel="nofollow external" href="https://home.pl/firma/">home.pl</a></strong>. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej w Polsce. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
    <br />
    <h2 style={{ textAlign: 'center'}}>§10 Sposób przetwarzania danych osobowych</h2>
    ...
    <h2 style={{ textAlign: 'center'}}>§11 Podstawy prawne przetwarzania danych osobowych</h2>
    ...
    <h2 style={{ textAlign: 'center'}}>§12 Okres przetwarzania danych osobowych</h2>
    <p><strong>Dane osobowe podane dobrowolnie przez Użytkowników:</strong></p>
    ...
    <h2 style={{ textAlign: 'center'}}>§13 Prawa Użytkowników związane z przetwarzaniem danych osobowych</h2>
    <p>Serwis gromadzi i przetwarza dane Użytkowników na podstawie:</p>
    <ul>
        <li>
    ...
    <ul>
        <li>
            <p><strong>Adres poczty elektronicznej</strong> - librotuo@gmail.com</p>
        </li>
        <li>
...
const PolicyHTMLContainer = styled.div`
    background: #0c0c0c;
    color: grey;
    padding: 2rem;
    margin-top: -80px;
